...
export const TokenChart = () => {
  ...
  const [duration, setDuration] = useState<'1D' | '1W' | '1M'>('1D');
  ...
  const { data, isLoading, isError } = useCryptoChart(selectedToken?.Name, duration);
              ...
              >
                ...
                >
                  ...
                  <RechartsPrimitive.Area
                    ...
                    strokeWidth={2}
                    dot={{ stroke: 'hsl(var(--chart-1))', fill: 'hsl(var(--chart-1))' }}
                  />
                </RechartsPrimitive.AreaChart>
              </ChartContainer>
            ) : data && data.length > 0 ? (
