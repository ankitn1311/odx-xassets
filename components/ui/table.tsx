...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      'h-11 border-b border-border px-2 text-left align-middle text-[13px] font-normal text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]',
      className
    )}
    {...props}
  />
